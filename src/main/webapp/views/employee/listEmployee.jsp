...
<div class="container">
  <h1> List Student</h1>
  <form >
    <a href="/employee/getFormCreate" class="button-linkAdd">Add Employee</a>
...
<%--        <td>${student.address}</td>--%>
        <td>
          <a href="/employee/update/${employee.id}" class="button-link1">Edit</a>
          <a href="/employee/delete/${employee.id}" class="button-link2">Delete</a>
        </td>
      </tr>
    </c:forEach>
    </tbody>
