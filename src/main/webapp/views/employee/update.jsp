...
<div class="container">
    <div class="row">
        ...
        <form class="col-6" action="/employee/update" method="post" enctype="multipart/form-data">
...
<%--                <input name="classname" value="${employee.classname}" type="text" class="form-control">--%>
<%--            </div>--%>
